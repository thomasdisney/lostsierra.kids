...
const parentLinks = [
  ...
  { href: "/portal/attendance", label: "Attendance", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
  ...
  { href: "/portal/reports", label: "Weekly Reports", icon: "M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
...
export function Sidebar() {
  ...
  const visibleParentLinks = isNewUser
    ? newUserLinks
    : isNewAccount
      ? newAccountLinks
      : parentLinks;
    ...
    <aside className="flex h-screen w-64 flex-col border-r border-paper-200 bg-white">
      ...
      <nav className="flex-1 overflow-y-auto p-4">
        <div className="mb-2 text-xs font-semibold uppercase tracking-wider text-paper-300">
          {isNewUser || isNewAccount ? "Getting Started" : "Family"}
        </div>
